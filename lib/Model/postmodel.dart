...
class Postmodel {
  ...
  Postmodel.fromJson(dynamic json) {
    if (json['recipes'] != null) {
      ...
      json['recipes'].forEach((v) {
        _recipes?.add(Recipes.fromJson(v));
      });
    }
    _total = json['total'];
    _skip = json['skip'];
  ...
  num? _skip;
  num? _limit;
Postmodel copyWith({  List<Recipes>? recipes,
  num? total,
  num? skip,
  num? limit,
}) => Postmodel(  recipes: recipes ?? _recipes,
  total: total ?? _total,
  skip: skip ?? _skip,
  limit: limit ?? _limit,
);
...
class Recipes {
  ...
  Recipes.fromJson(dynamic json) {
    ...
    _mealType = json['mealType'] != null ? json['mealType'].cast<String>() : [];
  }
  num? _id;
  String? _name;
...
Recipes copyWith({  num? id,
  ...
  prepTimeMinutes: prepTimeMinutes ?? _prepTimeMinutes,
  cookTimeMinutes: cookTimeMinutes ?? _cookTimeMinutes,
  servings: servings ?? _servings,
  difficulty: difficulty ?? _difficulty,
  cuisine: cuisine ?? _cuisine,
  caloriesPerServing: caloriesPerServing ?? _caloriesPerServing,
  tags: tags ?? _tags,
  ...
  num? get prepTimeMinutes => _prepTimeMinutes;
  num? get cookTimeMinutes => _cookTimeMinutes;
  num? get servings => _servings;
  String? get difficulty => _difficulty;
  String? get cuisine => _cuisine;
  num? get caloriesPerServing => _caloriesPerServing;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['prepTimeMinutes'] = _prepTimeMinutes;
    map['cookTimeMinutes'] = _cookTimeMinutes;
